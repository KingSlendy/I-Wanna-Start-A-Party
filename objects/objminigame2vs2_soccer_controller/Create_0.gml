...
alarm_override(11, function() {
	for (var i = 2; i <= global.player_max; i++) {
		...
		with (player) {
			...
			var is_keeper = (collision_line(xstart + 48 * sign_middle, ystart, xstart + 48 * sign_middle, ystart - 128, objMinigame2vs2_Soccer_Goal, false, true) != noone);//place_meeting(xstart + 32 * sign_middle, ystart - 96, objMinigame2vs2_Soccer_Goal);
