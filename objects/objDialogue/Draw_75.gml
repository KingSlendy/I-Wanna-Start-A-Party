...
if (dialogue_sprite == noone) {
	...
	draw_sprite_ext(sprBoxFill, 0, 0, 0, width, height, 0, c_dkgray, 1);
	draw_sprite_stretched(sprBoxFrame, 0, 0, 0, width, height);
	surface_reset_target();

	dialogue_sprite = sprite_create_from_surface(surf, 0, 0, width, height, false, false, 0, 0);
}

draw_sprite_ext(dialogue_sprite, 0, x, y + curve_y, 1, 1, 0, c_white, 1);
...
draw_surface_ext(text_surf, x + border_width, y + curve_y + border_width, 1, 1, 0, c_white, 1);