...
stock = [
	{
		text: "{SPRITE,sprCoin,0,0,2,0.7,0.7} ", name: language_get_text("WORD_GENERIC_COINS"), desc: language_get_text("PARTY_BOARD_BLACKHOLE_COINS_DESCRIPTION"), price: global.min_blackhole_coins, can_select: function() {
