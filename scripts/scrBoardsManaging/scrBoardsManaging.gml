...
function board_init() {
	global.boards = [
		...
		new Board("Kid VS. The World", rBoardWorld, "Kogami Takara\nKingSlendy", "Welcome to everyone versus the world!", ["In this board, your objective is to reach the flying Scott, once you reach him, it gives you one Shine! And that also applies if he reaches you.", "However, there's the spooky Ghost, which does the opposite! When it reaches you or you reach him, it takes one Shine away!", "Plan your route accordingly and try to avoid Ghost at all costs!"])
	];
}
