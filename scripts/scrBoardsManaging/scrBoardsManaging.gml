...
function board_init() {
	global.boards = [
		...
		new Board("Kid VS. The World", rBoardWorld, "Kogami Takara\nKingSlendy", "Welcome to everyone versus the world!", ["You gotta be careful! There's a spooky Ghost roaming around! When it reaches you or you reach him, it takes one Shine away!", "Plan your route accordingly and try to avoid Ghost at all costs while you collect Shines!"])
	];
}
