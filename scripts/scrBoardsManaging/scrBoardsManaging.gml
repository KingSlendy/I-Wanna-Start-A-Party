...
function board_init() {
	global.boards = [
		...
		new Board("Kid VS. The World", rBoardWorld, "Kogami Takara\nKingSlendy", "Welcome to everyone versus the world!", ["This is yet another simple board. You only gotta reach the Shine once again!"])
	];
}
