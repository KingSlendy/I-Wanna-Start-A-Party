...
function minigame_init() {
	...
	m[$ "4vs"] = [
		...
		new Minigame(UNCERTAIN_BULLETS, [DESC_START draw_page("Rules", "There's a line of bullets, blue is 1 point, yellow is 2, purple takes away 1 and gray takes away all. Select the number of bullets to move with the die, you jump after the bullets moved. Get 5 points to win!") DESC_END, DESC_START draw_page("Controls", draw_action(global.actions.jump) + " Hit Die") DESC_END], 30, rMinigame4vs_Bullets, "I Wanna Be A Big Man"),
	...
	m[$ "2vs2"] = [
		...
		new Minigame(WESTERN_DUEL, [DESC_START draw_page("Rules", "Pay attention! Be the fastest shooter on the old west. Once you see the exclamation mark, shoot as fast as you can. Whoever shoots faster wins 1 point. Reach 6 points to win.") DESC_END, DESC_START draw_page("Controls", draw_action(global.actions.shoot) + " Shoot") DESC_END], 28, rMinigame2vs2_Duel, "I Wanna Be The Galaxy"),
