...
function minigame_init() {
	...
	m[$ "4vs"] = [
		...
		new Minigame(CRAZY_CHESTS, language_get_text("MINIGAMES_CHESTS_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_CHESTS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.up) + " Pick Chest") DESC_END], 19, rMinigame4vs_Chests, "I Wanna Be The Fangame"),
		new Minigame(SLIME_ANNOYER, language_get_text("MINIGAMES_SLIME_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"),	language_get_text("MINIGAMES_SLIME_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 23, rMinigame4vs_Slime, "SlimePark"),
		new Minigame(ROCKET_IGNITION, language_get_text("MINIGAMES_ROCKET_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_ROCKET_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Turn\n" + draw_action(global.actions.up) + " Accelerate Forward\n" + draw_action(global.actions.down) + " Accelerate Backwards\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 24, rMinigame4vs_Rocket, "I Wanna Walk Out In The Morning Dew"),
		new Minigame(DIZZY_CONUNDRUM, language_get_text("MINIGAMES_DIZZY_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DIZZY_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Flip Gravity\n" + draw_action(global.actions.left) + draw_action(global.actions.up) + draw_action(global.actions.down) + draw_action(global.actions.right) + draw_action(global.actions.jump) + " After Shuffle") DESC_END], 25, rMinigame4vs_Dizzy, "VoVoVo"),
		...
		new Minigame(DRAWN_KEYS, language_get_text("MINIGAMES_DRAWN_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DRAWN_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 31, rMinigame4vs_Drawn, "I Wanna Be Drawn"),
		...
		new Minigame(JINGLE_SLEDGE, language_get_text("MINIGAMES_JINGLE_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_JINGLE_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot/Toggle") DESC_END], 35, rMinigame4vs_Jingle, "Jingle Jam")
	];
	...
	m[$ "2vs2"] = [
		new Minigame(A_MAZE_ING, language_get_text("MINIGAMES_MAZE_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_MAZE_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump Infinitely") DESC_END], 1, rMinigame2vs2_Maze, "I Wanna Kill The Kamilia 3"),
		...
		new Minigame(DYNYAAMIC_DUOS, language_get_text("MINIGAMES_DUOS_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DUOS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 21, rMinigame2vs2_Duos, "I Wannyaaaaaaa"),
		new Minigame(WESTERN_DUEL, language_get_text("MINIGAMES_DUEL_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DUEL_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.shoot) + " Shoot") DESC_END], 28, rMinigame2vs2_Duel, "I Wanna Be The Galaxy"),
		new Minigame(SOCCER_MATCH, language_get_text("MINIGAMES_SOCCER_NAME"), [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_SOCCER_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 29, rMinigame2vs2_Soccer, "I Wanna Be The GReeeeN"),
