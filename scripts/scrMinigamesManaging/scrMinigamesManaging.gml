...
function minigame_init() {
	...
	m[$ "4vs"] = [
		new Minigame(FOLLOW_THE_LEAD, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_LEAD_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.down) + draw_action(global.actions.right) + " Direction\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 2, rMinigame4vs_Lead, "I Wanna Be The Boshy"),
		new Minigame(TOWER_ASCENSION, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_TOWER_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move") DESC_END], 4, rMinigame4vs_Tower, "I Wanna Be The Guy"),
		new Minigame(HAUNTED_FOREST, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_HAUNTED_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move") DESC_END], 8, rMinigame4vs_Haunted, "I Wanna Kill The Guy"),
		new Minigame(MAGIC_MEMORY, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_MAGIC_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.up) + draw_action(global.actions.down) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Hold/Release Item\n" + draw_action(global.actions.shoot) + " Cover Items") DESC_END], 9, rMinigame4vs_Magic, "Not Another Magic Tower Game"),
		new Minigame(MANSION_ESCAPE, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_MANSION_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.up) + " Open Door") DESC_END], 10, rMinigame4vs_Mansion, "Kid World"),
		new Minigame(PAINTING_PLATFORMS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_PLATFORMS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 16, rMinigame4vs_Painting, "I Wanna Thank You Mauricio Juega IWBT"),
		new Minigame(BUGS_AROUND, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_BUGS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Change Number") DESC_END], 17, rMinigame4vs_Bugs, "I Wanna Delete The Huge Bug"),
		new Minigame(UNSTABLE_BLOCKS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_BLOCKS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 18, rMinigame4vs_Blocks, "I Wanna Thank You TheNewGeezer"),
		new Minigame(CRAZY_CHESTS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_CHESTS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.up) + " Pick Chest") DESC_END], 19, rMinigame4vs_Chests, "I Wanna Be The Fangame"),
		new Minigame(SLIME_ANNOYER, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"),	language_get_text("MINIGAMES_SLIME_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 23, rMinigame4vs_Slime, "SlimePark"),
		new Minigame(ROCKET_IGNITION, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_ROCKET_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Turn\n" + draw_action(global.actions.up) + " Accelerate Forward\n" + draw_action(global.actions.down) + " Accelerate Backwards\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 24, rMinigame4vs_Rocket, "I Wanna Walk Out In The Morning Dew"),
		new Minigame(DIZZY_CONUNDRUM, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DIZZY_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Flip Gravity\n" + draw_action(global.actions.left) + draw_action(global.actions.up) + draw_action(global.actions.down) + draw_action(global.actions.right) + draw_action(global.actions.jump) + " After Shuffle") DESC_END], 25, rMinigame4vs_Dizzy, "VoVoVo"),
		new Minigame(TARGETING_TARGETS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"),	language_get_text("MINIGAMES_TARGETS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 27, rMinigame4vs_Targets, "I Wanna Be The Micromedley"),
		new Minigame(UNCERTAIN_BULLETS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_BULLETS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 30, rMinigame4vs_Bullets, "I Wanna Be A Big Man"),
		new Minigame(DRAWN_KEYS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DRAWN_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 31, rMinigame4vs_Drawn, "I Wanna Be Drawn"),
		new Minigame(BUBBLE_DERBY, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_BUBBLE_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.up) + draw_action(global.actions.down) + draw_action(global.actions.right) + " Move") DESC_END], 36, rMinigame4vs_Bubble, "I Wanna Enjoy The Excursion"),
		new Minigame(SKY_DIVING, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_SKY_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.up) + draw_action(global.actions.down) + draw_action(global.actions.right) + " Move") DESC_END], 38, rMinigame4vs_Sky, "I Wanna Kill The Kamilia"),
		new Minigame(GOLF_COURSE, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_GOLF_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Adjust Angle\n" + draw_action(global.actions.jump) + " Use Angle/Use Force\n" + draw_action(global.actions.shoot) + " Cancel Angle") DESC_END], 39, rMinigame4vs_Golf, "I Wanna Run The Marathon"),
		new Minigame(WAKA_EVASION, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_WAKA_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Change Location") DESC_END], 40, rMinigame4vs_Waka, "I Wanna Be The Onelife"),
		new Minigame(JINGLE_SLEDGE, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_JINGLE_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot/Toggle") DESC_END], 35, rMinigame4vs_Jingle, "Jingle Jam")
	];

	m[$ "1vs3"] = [
		new Minigame(AVOID_THE_ANGUISH, [DESC_START draw_page(language_get_text("MINIGAMES_RULES_SOLO_PLAYER"),	language_get_text("MINIGAMES_AVOID_PAGE_1", "{COLOR,0000FF}", "{COLOR,FFFFFF}")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_RULES_TEAM_PLAYERS"), language_get_text("MINIGAMES_AVOID_PAGE_2", "{COLOR,0000FF}", "{COLOR,FFFFFF}")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 5, rMinigame1vs3_Avoid, "I Wanna Be The Lucky"),
	...
	m[$ "2vs2"] = [
		new Minigame(A_MAZE_ING, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_MAZE_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump Infinitely") DESC_END], 1, rMinigame2vs2_Maze, "I Wanna Kill The Kamilia 3"),
		new Minigame(CATCH_THE_FRUITS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_FRUITS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move") DESC_END], 6, rMinigame2vs2_Fruits, "I Wanna Be The Aura"),
		new Minigame(BUTTONS_EVERYWHERE, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_BUTTONS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump Infinitely\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 3, rMinigame2vs2_Buttons, "I Wanna Destroy The 6 Players"),
		new Minigame(FITTING_SQUARES, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_SQUARES_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Change Square Angle") DESC_END], 12, rMinigame2vs2_Squares, "I Wanna Reach The Moon"),
		...
		new Minigame(SPRINGING_PIRANHA, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_SPRINGING_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 20, rMinigame2vs2_Springing, "I Wanna Be The Co-op"),
		new Minigame(DINNYAMIC_DUOS, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DUOS_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump\n" + draw_action(global.actions.shoot) + " Shoot") DESC_END], 21, rMinigame2vs2_Duos, "I Wannyaaaaaaa"),
		new Minigame(WESTERN_DUEL, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_DUEL_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.shoot) + " Shoot") DESC_END], 28, rMinigame2vs2_Duel, "I Wanna Be The Galaxy"),
		new Minigame(SOCCER_MATCH, [DESC_START draw_page(language_get_text("MINIGAMES_RULES"), language_get_text("MINIGAMES_SOCCER_PAGE_1")) DESC_END, DESC_START draw_page(language_get_text("MINIGAMES_CONTROLS"), draw_action(global.actions.left) + draw_action(global.actions.right) + " Move\n" + draw_action(global.actions.jump) + " Jump") DESC_END], 29, rMinigame2vs2_Soccer, "I Wanna Be The GReeeeN"),
