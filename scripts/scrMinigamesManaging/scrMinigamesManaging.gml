...
function minigame_init() {
	...
	m[$ "4vs"] = [
		...
		new Minigame(UNCERTAIN_BULLETS, [DESC_START draw_page("Rules", "There's a line of bullets, blue is 1 point, yellow is 2, purple takes away 1 and gray takes 2. Select the number of bullets to move with the die, you jump after the bullets moved. Get 4 points to win!") DESC_END, DESC_START draw_page("Controls", draw_action(global.actions.jump) + " Hit Die") DESC_END], 30, rMinigame4vs_Bullets, "I Wanna Be A Big Man"),
