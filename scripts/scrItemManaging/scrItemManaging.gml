...
global.board_items = [
	...
	new Item(ItemType.Warp, "Warp", "Changes location with the player you choose.", sprItemWarp, 25),
	...
	new Item(ItemType.Mirror, "Mirror", "Teleports you right next to the shine.", sprItemMirror, 30),
