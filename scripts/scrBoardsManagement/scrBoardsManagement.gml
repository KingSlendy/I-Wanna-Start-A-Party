...
function board_init() {
	global.boards = [
		...
		new Board(language_get_text("PARTY_BOARD_PALLET_NAME"), rBoardPallet, "KingSlendy", language_get_text("PARTY_BOARD_PALLET_WELCOME"), [language_get_text("PARTY_BOARD_PALLET_RULES_1"), language_get_text("PARTY_BOARD_PALLET_RULES_2", draw_coins_price(15)), language_get_text("PARTY_BOARD_PALLET_RULES_3", draw_coins_price(10), draw_coins_price(10)), language_get_text("PARTY_BOARD_PALLET_RULES_4"), language_get_text("PARTY_BOARD_PALLET_RULES_5"), language_get_text("PARTY_BOARD_PALLET_RULES_6")]),
		...
		new Board(language_get_text("PARTY_BOARD_HYRULE_NAME"), rBoardHyrule, "KingSlendy", language_get_text("PARTY_BOARD_HYRULE_WELCOME"), [language_get_text("PARTY_BOARD_HYRULE_RULES_1"), language_get_text("PARTY_BOARD_HYRULE_RULES_2"), language_get_text("PARTY_BOARD_HYRULE_RULES_3"), language_get_text("PARTY_BOARD_HYRULE_RULES_4", draw_coins_price(20)), language_get_text("PARTY_BOARD_HYRULE_RULES_5")]),
